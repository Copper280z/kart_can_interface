...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, bmi088_accel_cs_Pin|bmi088_gyro_cs_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : OSD_SPI_MISO_Pin */
  GPIO_InitStruct.Pin = OSD_SPI_MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
  HAL_GPIO_Init(OSD_SPI_MISO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : M6_Pin M5_Pin */
  GPIO_InitStruct.Pin = M6_Pin|M5_Pin;
  ...
  /*Configure GPIO pin : UART1_TX_Pin */
